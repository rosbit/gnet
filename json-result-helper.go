...
func HttpCallJ(url string, res interface{}, options ...Option) (int, error) {
	return callGNetJ(url, http_i, res, options...)
}

func JSONCallJ(url string, res interface{}, options ...Option) (int, error) {
	return callGNetJ(url, json_i, res, options...)
}

func callGNetJ(url string, fnCall httpFunc_i, res interface{}, options ...Option) (int, error) {
